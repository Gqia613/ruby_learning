...
p a`,
        ...
        {
            question: "配列[7, 5, 3]を取得するために__(?)__に入る正しい記述はどれですか？",
            code: `x = [ 9, 7, 5, 3, 1 ]
p x[__(?)__]`,
            choices: ["1, 3", "1..3", "1...4", "1, 3 と 1..3 の両方"],
            correct: 3,
            explanation: "<code>x[1, 3]</code>は位置1から3要素、<code>x[1..3]</code>は位置1から位置3まで（含む）を返します。どちらも[7, 5, 3]です。"
        },
        {
            question: "次のコードの実行結果として正しいものはどれですか？",
            code: `puts "42A7".to_i`,
